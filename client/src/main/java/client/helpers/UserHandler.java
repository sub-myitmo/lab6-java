...
public class UserHandler {
    ...
    private StatusOfCode conversionCommand(String command, String commandArgument) {
        try {
            switch (command) {
                case "":
    ...
    public UserRequest handle(ResponseCode responseCode) {
        String userInput;
        ...
        try {
            do {
                ...
                status = conversionCommand(userCommand[0], userCommand[1]);
            ...
            try {
                ...
                switch (Objects.requireNonNull(status)) {
                    case OBJECT:
                        ...
                        return new UserRequest(userCommand[0], userCommand[1], group);
                    case SCRIPT:
        ...
        return new UserRequest(userCommand[0], userCommand[1]);
    }
}
